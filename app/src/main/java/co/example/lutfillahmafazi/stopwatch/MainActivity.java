package co.example.lutfillahmafazi.stopwatch;
...
public class MainActivity extends AppCompatActivity {
    ...
    Handler handler;
    int Seconds, Minutes, Milisecond;
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(MainActivity.this, android.R.layout.activity_list_item,ListElementArrayList);
    ...
    public Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            textView.setText(" " + Minutes + ":" + String.format("%02d", Seconds) + ":" + String.format("%03d", Milisecond));
